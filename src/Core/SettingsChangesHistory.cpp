...
const VersionToSettingsChangesMap & getSettingsChangesHistory()
{
    ...
    std::call_once(initialized_flag, [&]
    {
        ...
        addSettingsChanges(settings_changes_history, "26.8",
        {
            ...
            {"query_plan_ie_join_select_conditions_by_selectivity", false, true, "New setting to choose the two IEJoin key conditions by their estimated selectivity from column statistics instead of the first two in syntax order."},
